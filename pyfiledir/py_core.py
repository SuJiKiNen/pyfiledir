...
if __package__ is None or __package__ == "":
    ...
    from py_env import PYFILEDIR_ENVS as _ENV
else:
    from pyfiledir.py_polyphone import PY_POLYPHONE
    from pyfiledir.py_env import PYFILEDIR_ENVS as _ENV
...
def do_polyphone_match(cn_char, alpha):
    return cn_char in PY_POLYPHONE.keys() and alpha in PY_POLYPHONE[cn_char]
...
def do_py_completion(path):
    ...
    if (
        ...
        and (_ENV.PYFILEDIR_ADD_TRAILING_SLASH or same_path(ret[0], path))
